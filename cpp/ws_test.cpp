...
static int
callback_dumb_increment(struct libwebsocket_context *this_context,
...
/*    fprintf(stderr, "rx %d '%s'\n", (int)len, (char *)in); */
  ...
  case LWS_CALLBACK_CLIENT_WRITEABLE:
    ...
    n = libwebsocket_write(wsi,
       &buf[LWS_SEND_BUFFER_PRE_PADDING], l, (libwebsocket_write_protocol) (opts | LWS_WRITE_TEXT));
...
use_ssl = 1;
  wsi_dumb = libwebsocket_client_connect(context, address, port, use_ssl,
      "/websocket/kcgxlXVhy9aAASXg0dZHzaylnZFszYAWS5Srz4rrZZ4r2wZRFMlhAUiAkmIKNpyhxtvWbxCowKytEe02q532Gg8TyQas58cFF8vTocYeO0d5J8TNqJP4d7BXhFYRAfrGYLpiAxVnCP5fnK8re_8XWA==", 
